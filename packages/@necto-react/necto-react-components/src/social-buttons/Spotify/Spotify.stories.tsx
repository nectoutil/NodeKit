...
const meta = {
  title: 'Social Buttons/Spotify Button',
  ...
  argTypes: {
    ...
    showIcon: {
      control: 'boolean',
      description: 'Show or hide the Spotify icon'
    },
    iconPosition: {
      control: 'radio',
      options: ['left', 'right'],
      description: 'Position of the Spotify icon'
    },
    as: {
      control: 'text',
...
} satisfies Meta<typeof SpotifyButton>;
